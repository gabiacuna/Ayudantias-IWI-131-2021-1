...
def altaCong(horario, dia):
    ...
    if dia in semana:
        ...
        cong = (7 == hora and 30 <= mins) or (9 == hora and 30 >= mins) or (7 < hora < 9)

        if cong == False:
            cong = (17 == hora and 30 <= mins) or (20 == hora and 0 == mins) or (17 < hora < 20)
    
    else:
        cong = (8 == hora and 30 <= mins) or (11 == hora and 0 == mins) or (8 < hora < 11)

        if cong == False:
            cong = (17 == hora and 45 <= mins) or (22 == hora and 30 >= mins) or (17 < hora < 22)
